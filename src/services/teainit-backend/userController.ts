...
/** getCurrentUserAndPerm GET /api/user/current */
export async function getCurrentUserAndPermUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponseCurrentUserVO_>('/api/user/current', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function userLoginUsingPost(
  ...
  return request<API.BaseResponseCurrentUserVO_>('/api/user/login', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
